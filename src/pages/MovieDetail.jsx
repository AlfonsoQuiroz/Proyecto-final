  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container container--movie-detail m-auto">
          <header>
            <h1 className="text-center font-bold ">{original_title} <span className="text-center">{tagline}</span></h1>
          ...
          <div>
            <h4 className="text-sky-600 font-bold t-align-start">Sinopsis</h4>
          ...
          <div>
            <h4 className="text-sky-600 font-bold t-align-start">Países de producción</h4>
            <ul className="list">
          ...
          <div>
            <h4 className="text-sky-600 font-bold t-align-start">Lenguajes hablados</h4>
            <ul className="list">
              {spoken_languages === undefined || spoken_languages.map((element, index) => <li key={index} className="list__item">{element.name}</li> ?? 'null')}
            </ul>
          </div>
          <div>
            <h4 className="text-sky-600 font-bold t-align-start">Balance</h4>
            <div className="action md:flex ">
              <h3>Presupuesto: <button>$ {budget}</button></h3>
              <h3>Recaudación:  <button>$ {revenue}</button></h3>
            </div>
          </div>
        </div>
      </section>
